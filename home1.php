...
<form action="http://localhost/inv/home1.php" method="post">
  ...
  <div class="container">
    ...
    <td colspan="2"><button type="submit" name="submit">Add Brand</button></td>
