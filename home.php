...
<ul>
  <li><a class="active" href="http://localhost/inv/home.php">Brand Master</a></li>
  ...
  <?php
      ...
      while($row=$result->fetch_assoc())
      {
        ...
        <tr>
          ...
          <td>".$row["brand"]."</td>
          <td>".$row["status"]."</td>   
          <td> <button><a href='http://localhost/inv/delete.php?id=$row[id]'>Delete</a></button></td>       
          <td> <button><a href='http://localhost/inv/edit.php?id=$row[id]'>Edit</a></button></td>  
        </tr>";
...
<button><a href="http://localhost/inv/home1.php">ADD Brand</a></button>
